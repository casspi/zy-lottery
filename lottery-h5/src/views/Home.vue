<template>
	...
	>
		...
		<div class="result-popup" v-if="showResult && result">
			<div class="result-popup-inner">
				...
				<p class="tips">停留在此页面，到Y15展台兑换奖品！</p>
	...
	<div class="not-wechat" v-else>
		<Icon name="warning-o" /> 请在微信客户端中打开
	</div>
</template>
<script setup>
import { ref, onMounted, reactive } from 'vue'
import axios from 'axios'
import { sleep, isWeChat } from '@daysnap/utils'
import { showToast, Empty, Icon } from 'vant'
import { v4 as uuidv4 } from 'uuid'
import { BASE_URL, __DEV__ } from '@/utils/constants'
